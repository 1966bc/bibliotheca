...
class Book
{
    ...
    {
        $sql = "SELECT b.book_id, b.title, b.pages, b.published,
    ...
    public function update(int $id, int $publisherId, int $categoryId, string $title, ?int $pages, ?int $published): int
    {
        $sql = "UPDATE book
